        ...
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) =>
                  WebView(url: model.shortUrl,title: model.title,)
              )
          );
        },
        child:  Container(
...
Padding(padding: EdgeInsets.only(left: 16),child:Column(
  children: <Widget>[
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
              model.title,
              style: TextStyle(
                  fontSize: 14, color: ColorUtils.appWhiteColor),
            ),
          ),
          Padding(
            padding: EdgeInsets.only(left: 8),
          ...
          Text(
            ...
            style: TextStyle(
                color: ColorUtils.appHomeMoreColor, fontSize: 14),
          ),
        ],
      ),
    ),
    ...
    Padding(padding: EdgeInsets.only(top: 8),)
              ...
              Align(
                ...
                child:Image.asset('images/im_paging_rig.png',fit: BoxFit.fitHeight),),
            ],
          ),
        ),
      ),
  ...
  String _getComma(String limit) {
    ...
    if (stringSige < 4) {
      ...
      return limit.substring(0, stringSige - 3) + ", " + limit.substring(stringSige - 3, stringSige);
    } else if (stringSige < 10) {
      return limit.substring(0, stringSige - 3)+", "+limit.substring(3, 6)+ ", " + limit.substring(stringSige - 3, stringSige);
    } else {
      return limit;
    }
  }
